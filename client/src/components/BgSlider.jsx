...
const BgSlider = () => {
  ...
  return (
    <div className="pb-10 md:py-20 mx-2">
      <h1 className="mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-800 to-transparent bg-clip-text text-transparent">
        Remove Background With High <br /> Quality and Accuracy{" "}
      </h1>
      <div className="relative max-w-3xl w-full overflow-hidden mx-auto rounded-xl">
